...
export const dataImportRoutes: RouteObject[] = [
  { path: BATCHES.INDEX, element: <ImportBatchesList />, handle: { title: "Import Batches" } satisfies DashboardHandle },
  { path: BATCHES.NEW, element: <NewImportBatch />, handle: { title: "Data Imports", back: true } satisfies DashboardHandle },
  { path: BATCHES.VIEW_PATH, element: <ViewBatch />, handle: { title: "Batch Detail", back: BATCHES.INDEX } satisfies DashboardHandle },
